...
$I->dontSee('Test-The head of the department of Computer Science is Prof. Nik Bessis.');

$I->see('Test-Who is the director of undergraduate studies?');
$I->dontSee('Test-The director of undergraduate studies is Dr. Mark Liptrott.');
