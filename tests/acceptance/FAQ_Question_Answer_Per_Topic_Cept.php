...
$I->click('Who is the head of the department?');
$I->see('The head of the department of Computer Science is Prof. Nik Bessis.');

$I->click('Who is the director of undergraduate studies?');
$I->see('The director of undergraduate studies is Dr. Mark Liptrott.');
$I->dontSee('The head of the department of Computer Science is Prof. Nik Bessis.');
